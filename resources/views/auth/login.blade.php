...
<div class="login-box">
  <!-- /.login-logo -->
  <img src="{{ asset('dist/img/login_logo2.png')}} " style="width:95%;">
  <div class="card card-outline card-primary">
    <div class="card-header text-center">

      <a href="" class="h1"><b>Sparley Petrol Pump
</b></a>
    </div>
    <div class="card-body">
      ...
      <p class="mb-1">
      <a class="text-center" href="{{ route('password.request') }}">Forget Password </a>
      </p>
       @endif
      <!-- <p class="mb-0">
